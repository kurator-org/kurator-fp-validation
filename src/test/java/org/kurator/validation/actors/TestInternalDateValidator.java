...
public class TestInternalDateValidator extends KuratorAkkaTestCase {
    ...
    public void testInternalDateValidator_EightRecords() throws Exception {
       ...
       String expected =
           ...
           "100004,Mark Elvin,3000,1990,5,21,37.0,-118.0,WGS84,United States,California,,Northern end of The Owens Valle Bishop,Asteraceae,Cirsium mohavense,(Greene) Petr.,Flower:June;July;August;September;October;November,DAV,FilteredPush,SPNHCDEMO,1024940765,1990-05-21,| eventDate is null? | EventDate is constructed from atomic fields | eventDate is null? | EventDate is constructed from atomic fields | Unable to get the Life span data of collector:Mark Elvin,Filled in,eventDate:null#Filteredpush Entomologists List" + EOL +
           "100005,Mark Elvin,2940,1990,5,12,34.0,-117.0,WGS84,United States,California,San Bernardino,l mi. NW of Lucerne Valley town center,Asteraceae,Cirsium mohavense,(Greene) Petr.,Flower:June;July;August;September;October;November,DAV,FilteredPush,SPNHCDEMO,1024940674,1990-05-12,| eventDate is null? | EventDate is constructed from atomic fields | eventDate is null? | EventDate is constructed from atomic fields | Unable to get the Life span data of collector:Mark Elvin,Filled in,eventDate:null#Filteredpush Entomologists List" + EOL +
           "100006,Mark Elvin,1940,1990,5,20,36.0,-118.0,WGS84,United States,California,Kern,Weldon Rancheria,Asteraceae,Cirsium mohavense,(Greene) Petr.,Flower:June;July;August;September;October;November,DAV,FilteredPush,SPNHCDEMO,1024940053,1990-05-20,| eventDate is null? | EventDate is constructed from atomic fields | eventDate is null? | EventDate is constructed from atomic fields | Unable to get the Life span data of collector:Mark Elvin,Filled in,eventDate:null#Filteredpush Entomologists List" + EOL +
           "100007,Mark Elvin,606,1990,5,16,21.312,-157.8055,WGS84,United States,Hawaii,Honolulu,Honolulu 3115 Kaloaluiki Place,Asteraceae,Tragopogon porrifolius,L.,Flower:April;May;June;July;August,DAV,FilteredPush,SPNHCDEMO,927140834,1990-05-16,| eventDate is null? | EventDate is constructed from atomic fields | eventDate is null? | EventDate is constructed from atomic fields | Unable to get the Life span data of collector:Mark Elvin,Filled in,eventDate:null#Filteredpush Entomologists List" + EOL +
