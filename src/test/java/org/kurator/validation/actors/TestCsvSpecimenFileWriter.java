...
public class TestCsvSpecimenFileWriter extends KuratorAkkaTestCase {
    ...
    public void testCsvSpecimenFileWriter_EightLineFile() throws Exception {
        ...
        String expected =
            "catalogNumber,recordedBy,fieldNumber,year,month,day,decimalLatitude,decimalLongitude,geodeticDatum,country,stateProvince,county,locality,family,scientificName,scientificNameAuthorship,reproductiveCondition,InstitutionCode,CollectionCode,DatasetName,Id,eventDate" + EOL +
